    ...
    {     
		...
		namespace test
		{
			...
			private:
				...
				Node* head;
				Node* tail;
				unordered_map<int, pair<Node*, int>> map; //key, (iter, val)

				void moveToFront(int key)
				{
					Node* node = map[key].first;
